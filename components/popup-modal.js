        ...
        <>
            {active && (
                <div className="fixed top-0 right-0 bottom-0 left-0">
                    ...
                    <div className="w-[50%] h-[50%] absolute bg-white transform top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 z-[100]">
                        ...
                        <div className="absolute bottom-0 border border-t w-full py-2 px-8 flex justify-end gap-3">
