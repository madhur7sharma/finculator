        ...
        <section className="dark relative">
            ...
            <footer className="bg-white dark:bg-gray-800">
                <div className="max-w-[1300px] mx-auto px-4 py-4">
                    ...
                    <hr className="h-px my-6 bg-gray-300 border-none dark:bg-gray-600" />

                    <div>
                        <p className="text-center text-gray-800 dark:text-white">© Finculator 2020 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </section>
