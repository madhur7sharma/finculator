...
const Alert = forwardRef(({ autoClose, autoCloseTime = 4000 }, ref) => {
                    ...
                    if (item.type === "success") {
                        return (
                            <div
                                ...
                                className="cursor-pointer mt-4 flex w-fit max-w-[300px] mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-700"
                            >
                                ...
                                <div className="px-4 py-2 -mx-3">
                                    <div className="mx-3">
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-200">{item.message}</p>
                                    </div>
                                </div>
                            </div>
                        );
